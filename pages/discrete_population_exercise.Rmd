...
I have started the function for you. Explain the code that is already there using comments, and include your own where necessary.

```{r, eval = FALSE}
dgrowth <- function(your arguments here) {
  n <- rep(NA, ngen)
  n[1] <- ______

  for (i in 2:ngen) {
    ______________ # calculate population size - hint eqn!
  }
  return(_______)
}
